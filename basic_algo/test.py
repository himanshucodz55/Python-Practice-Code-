...
class PyLouvain:
    ...
    def from_file(cls, path):
        ...
        # print("nodes_",nodes_,'edges_',edges_)
...
class PylouvainTest(unittest.TestCase):
   ...
   #      start = time.time()
   #      pyl = PyLouvain.from_file("data/sample_net.txt")
   #      partition, q = pyl.apply_method
   #      end = time.time()
   #      print("Execution time :: ", end-start)start
...
# listed=['0', '9', '14', '15', '16', '19', '20', '21', '23', '24', '27', '28', '29', '30', '31', '32', '33', '2', '1', '3', '4', '5', '6', '7', '8', '10', '11', '12', '13', '17', '18', '22', '26', '25']
# int(listed.sort())
# print(listed)